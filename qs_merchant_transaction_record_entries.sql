...
--
-- Dumping data for table `qs_merchant_transaction_record_entries`
--

LOCK TABLES `qs_merchant_transaction_record_entries` WRITE;
/*!40000 ALTER TABLE `qs_merchant_transaction_record_entries` DISABLE KEYS */;
