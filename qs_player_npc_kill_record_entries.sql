...
--
-- Dumping data for table `qs_player_npc_kill_record_entries`
--

LOCK TABLES `qs_player_npc_kill_record_entries` WRITE;
/*!40000 ALTER TABLE `qs_player_npc_kill_record_entries` DISABLE KEYS */;
