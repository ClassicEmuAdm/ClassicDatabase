...
--
-- Dumping data for table `pets_equipmentset`
--

LOCK TABLES `pets_equipmentset` WRITE;
/*!40000 ALTER TABLE `pets_equipmentset` DISABLE KEYS */;
INSERT INTO `pets_equipmentset` VALUES (1,'MageFocused61to75',-1),(2,'RagingServant',-1);
