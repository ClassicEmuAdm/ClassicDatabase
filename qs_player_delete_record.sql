...
--
-- Dumping data for table `qs_player_delete_record`
--

LOCK TABLES `qs_player_delete_record` WRITE;
/*!40000 ALTER TABLE `qs_player_delete_record` DISABLE KEYS */;
/*!40000 ALTER TABLE `qs_player_delete_record` ENABLE KEYS */;
UNLOCK TABLES;
