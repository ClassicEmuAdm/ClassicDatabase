...
--
-- Dumping data for table `qs_player_speech`
--

LOCK TABLES `qs_player_speech` WRITE;
/*!40000 ALTER TABLE `qs_player_speech` DISABLE KEYS */;
/*!40000 ALTER TABLE `qs_player_speech` ENABLE KEYS */;
UNLOCK TABLES;
