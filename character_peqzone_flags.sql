...
--
-- Dumping data for table `character_peqzone_flags`
--

LOCK TABLES `character_peqzone_flags` WRITE;
/*!40000 ALTER TABLE `character_peqzone_flags` DISABLE KEYS */;
/*!40000 ALTER TABLE `character_peqzone_flags` ENABLE KEYS */;
UNLOCK TABLES;
