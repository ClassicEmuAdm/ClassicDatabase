...
--
-- Dumping data for table `qs_merchant_transaction_record`
--

LOCK TABLES `qs_merchant_transaction_record` WRITE;
/*!40000 ALTER TABLE `qs_merchant_transaction_record` DISABLE KEYS */;
/*!40000 ALTER TABLE `qs_merchant_transaction_record` ENABLE KEYS */;
UNLOCK TABLES;
