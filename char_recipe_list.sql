...
--
-- Dumping data for table `char_recipe_list`
--

LOCK TABLES `char_recipe_list` WRITE;
/*!40000 ALTER TABLE `char_recipe_list` DISABLE KEYS */;
/*!40000 ALTER TABLE `char_recipe_list` ENABLE KEYS */;
UNLOCK TABLES;
